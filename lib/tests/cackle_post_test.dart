...
import 'package:soulful/tests/cackle.dart';
...
void main() async {
  ...
  Client client = Client().setEndpoint("https://cloud.appwrite.io/v1").setProject(AppConfig.projectId).setSelfSigned();
